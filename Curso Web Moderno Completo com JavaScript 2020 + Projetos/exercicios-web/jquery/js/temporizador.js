(function ($) {
    $.fn.temporizador = function (opcoes) {
        /* forma de passar valores padroes, caso em opcoes n tenha mensagem ou horario
        eles serao substituidos pelos valores passados abaixo.
        Os valores serao atribuidos para opcoesFinais*/
        ...
        let temporizador = setInterval(() => {
            ...
            if (diferencaEmMili >= 0) {
                //toISOString para a data sem a mudança do timezone (é ativada por padrao)
